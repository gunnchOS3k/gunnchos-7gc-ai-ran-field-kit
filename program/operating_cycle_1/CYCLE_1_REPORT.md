...
| field-kit | *(this follow-up)* | *(tip after push)* | **OPEN DRAFT** | *(pending CI)* | null | Cycle 1 report; depends_on owner #81 green + Edmund merges + accepted-main reproof before promotion |

...
\begin{itemize}
  ...
  \item primary outcome \texttt{total\_service\_outage\_time\_s} and secondary \texttt{time\_to\_recovery\_s} (with censoring rates) by baseline and holdout split,

...
\begin{itemize}
  ...
  \item A preregistered statistical analysis plan with primary outcome \texttt{total\_service\_outage\_time\_s} (Amendment~001, in progress) and secondary \texttt{time\_to\_recovery\_s}; baseline registries frozen before authentic pilot inspection.

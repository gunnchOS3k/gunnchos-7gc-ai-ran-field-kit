...
PDF build uses pinned Tectonic (\texttt{scripts/build\_paper.sh}, version pinned in-script) or a digest-pinned TeX Live Docker image; local \texttt{pdflatex}/\texttt{bibtex} remains an optional fallback. See \texttt{paper/Makefile} and \texttt{paper/README.md}.

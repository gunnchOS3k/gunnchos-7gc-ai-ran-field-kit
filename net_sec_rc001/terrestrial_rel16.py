"""Quectel RM520N-GL Rel-16 terrestrial digital runtime.

Honest: Rel-16 NSA+SA Sub-6 only. NOT 5G-Advanced hardware. NOT NTN. NOT 6G.
CARRIER EXTERNAL_PENDING. Does not earn 5GA_TERRESTRIAL_DIGITAL_RUNTIME.
"""
...
CLAIM = (
    "Simulated Quectel RM520N-GL Rel-16 NSA+SA Sub-6 terrestrial path only. "
    "Not 5G-Advanced modem capability. Not NTN. Not 6G. "
    "CARRIER_ACCEPTED=false. CARRIER EXTERNAL_PENDING. "
    "5GA_TERRESTRIAL_DIGITAL_RUNTIME remains false for this surface."
)
...
class RM520NTerrestrialDigital:
    ...
    def connect(self) -> dict[str, Any]:
        ...
        return {"ok": True, "connected": True, "path": "cellular_rel16"}

    def failover(self, to: str = "wifi") -> dict[str, Any]:
        self.state["active_path"] = to
        return {"ok": True, "from": "cellular_rel16", "to": to, "policy": "service_continuity"}
    ...
    def run(self) -> dict[str, Any]:
        ...
        ok = all(
            [
                ...
                seq[3][1]["ok"],
                seq[3][1]["five_ga_claimed"] is False,
                seq[5][1]["ok"],
                seq[6][1]["ok"],
                seq[7][1]["ok"],
                nsa_reg["ok"],
                self.ntn_capable is False,
                self.five_ga_capable is False,
        ...
        return {
            "schema": "gunnchos.net_sec_rc001.terrestrial_rel16.v1",
            "ok": ok,
            "sku": self.sku,
            "release": self.release,
            ...
            "token_candidate": "5G_REL16_TERRESTRIAL_DIGITAL_RUNTIME",
            "does_not_earn": "5GA_TERRESTRIAL_DIGITAL_RUNTIME",
        }

        # Reproducibility — gunnchos 7GC AI-RAN Field Kit
...
# Expected: CI smoke pass; tests pass or documented skip
        ...
        **Real today:** Synthetic benchmarks, schema-validated telemetry examples, umbrella documentation, CI smoke validation

        **Synthetic / demo-only:** AI-RAN ablation tables, emulator telemetry, cross-repo integration diagrams

        **Planned:** Field campaigns, Zenodo DOI, near-RT RIC integration, Android APK field console

        **Not claimed:** Commercial 6G, carrier-grade AI-RAN, citywide deployment, unauthorized RF transmission
